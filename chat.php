                        ...
                        <div class="card">
                          <div class="card-body"> 
                                ...
                                <div class="row">
                                    ...
                                    <div id="panel-hide">
                                      <h2 style="margin-left:200px; margin-top: 100px;">Welcome To Personal Chat</h2>
                                      <img src="uploads/chatimage.jpg" style="margin-left: 50px; ">
                                    </div>
                <!--Chat Model Open -->  
                <div class="col-lg-9" id="panel" style="margin-top: 100px;">
                  <div class="card-body"> 
                      ...
                      <div class="form-group col-sm-6">
                        ...
                        <div class="col-lg-12 chat-box scrollable" id="chat_box" style="height:350px;">
                                  ...
                                  <div class="row">
                                    <div class="col-lg-8">
                                        <div class="input-field m-t-0 m-b-0">
                                           <input type="text" id="message_send" placeholder="Type message..."class="form-control border-5" name="message" rows="2" cols="50">
...
message_send.addEventListener("keyup", function(event) {
  ...
  $.ajax({
      url:"admin_allfunction.php?call=project_personal_search",
      method:"post",
...
function send()
{
      ...
      $.ajax({
        ...
        url: 'admin_allfunction.php?call=personal_msg_insert',
...
function fetch_msg(refer_id){
  ...
  $.ajax({
      url:"admin_allfunction.php?call=fetch_personal_message",
      method:"post",
...
function showdata(refer_id){
    ...
    $.ajax({
      url:"admin_allfunction.php?call=project_personal_chat",
      method:"post",
      data:{refer_id:refer_id},
      success:function(data){
        console.log(data);
