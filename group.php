...
.chat-list .chat-item.reverse .chat-content {
	...
	padding-right: 15px
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Personal Chat</h4>
                                ...
                                <!-- <div class="row">
                                    <div class="col-lg-3" style="margin-top: 100px;">
                                        <div   style="background: #87cefa;   color:black; padding: 2px; margin-top: -20px; width: 250px; margin-left: -20px;">
                                            <h6 class="card-title m-t-5" style="text-align: center;"><strong  class="fab fa-rocketchat"> Personal Chat</strong></h6>
                                        </div>
                                    ...
                                    <div id="panel-hide">
                                      <h2 style="margin-left:450px; margin-top: 100px;">Welcome To Personal Chat</h2>
                                      <!-- <img src="uploads/chatimage.jpg" style="margin-left: 50px; ">
                                    </div> -->
                <!--Chat Model Open -->  
                <div class="col-lg-9" id="panel" ">
                  <div class="card-body"> 
                      ...
                      <!-- <div class="form-group col-sm-6">
                        ...
                        <div class="col-lg-12 chat-box scrollable" id="chat_box" style="height:350px;width: 1290px">
                                  ...
                                  <div class="row">
                                    <div class="col-lg-8">
                                        <div class="input-field m-t-0 m-b-0">
                                           <input type="text" id="message_send" placeholder="Type message..."class="form-control border-5" style="height: 40px;width: 1100px;" name="message" rows="2" cols="50">
                                           <span id="message_sendv" style="color:red; font-size: 12px;"></span>
                                        </div>
                                    </div>
                                    <div class="col-lg-1">
                                      <input type="submit" name="message" id="messagesend" style="margin-left: 500px;width: 100px;height: 40px"class=" btn btn-primary" value="Send" onclick="send();">
                                    </div>
                                  </div>
                                </div>
                            </div>
            ...
            <script src="../E_forum/admin/assets/libs/jquery/dist/jquery.min.js"></script>
    <script src="../E_forum/admin/assets/libs/popper.js/dist/umd/popper.min.js"></script>
    <script src="../E_forum/admin/assets/libs/bootstrap/dist/js/bootstrap.min.js"></script>
    <script src="../E_forum/admin/assets/libs/perfect-scrollbar/dist/perfect-scrollbar.jquery.min.js"></script>
    <script src="../E_forum/admin/assets/extra-libs/sparkline/sparkline.js"></script>
    <script src="../E_forum/admin/dist/js/waves.js"></script>
    <script src="../E_forum/admin/dist/js/sidebarmenu.js"></script>
    <script src="../E_forum/admin/dist/js/custom.min.js"></script>
    <script src="../E_forum/admin/assets/libs/inputmask/dist/min/jquery.inputmask.bundle.min.js"></script>
    <script src="../E_forum/admin/dist/js/pages/mask/mask.init.js"></script>
    <script src="../E_forum/admin/assets/libs/select2/dist/js/select2.full.min.js"></script>
    <script src="../E_forum/admin/assets/libs/select2/dist/js/select2.min.js"></script>
    <script src="../E_forum/admin/assets/libs/jquery-asColor/dist/jquery-asColor.min.js"></script>
    <script src="../E_forum/admin/assets/libs/jquery-asGradient/dist/jquery-asGradient.js"></script>
    <script src="../E_forum/admin/assets/libs/jquery-asColorPicker/dist/jquery-asColorPicker.min.js"></script>
    <script src="../E_forum/admin/assets/libs/jquery-minicolors/jquery.minicolors.min.js"></script>
    <script src="../E_forum/admin/assets/libs/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js"></script>
    <script src="../E_forum/admin/assets/libs/quill/dist/quill.min.js"></script>
    <script>
...
message_send.addEventListener("keyup", function(event) {
  ...
  var refer_id = document.getElementById('refer_id').value;
    ...
    $.ajax({
      url:"allfunction2.php?call=project_personal_search",
      method:"post",
...
function send()
{
      ...
      $.ajax({
        ...
        url: 'allfunction2.php?call=personal_msg_insert',
...
function fetch_msg(refer_id){
  ...
  $.ajax({
      url:"allfunction2.php?call=fetch_personal_message",
      method:"post",
