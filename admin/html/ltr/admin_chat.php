                    ...
                    <div class="col-12 d-flex no-block align-items-center">
                        ...
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                   <!--  <li class="breadcrumb-item"><a href="group_chat.php">Project Group</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Personal Chat</li> -->
                                </ol>
                            </nav>
                        </div>
                    </div>
                          ...
                          <div class="card-body"> 
                                ...
                                <div class="row">
                                    ...
                                    <div id="panel-hide">
                                      ...
                                      <img src="./../../assets/images/chatimage.jpg" style="margin-left: 50px; ">
                                    </div>
                <!--Chat Model Open -->  
