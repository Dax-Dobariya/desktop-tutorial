...
message_send.addEventListener("keyup", function(event) {
 ...
 var refer_id = document.getElementById('refer_id').value;
    ...
    $.ajax({
      url:"allfunction.php?call=project_personal_search",
      method:"post",
...
function send()
{
    var refer_id = document.getElementById('refer_id').value;
      ...
      $.ajax({
        ...
        url: 'allfunction.php?call=personal_msg_insert',
...
function fetch_msg(refer_id){
  ...
  $.ajax({
      url:"allfunction.php?call=fetch_personal_message",
      method:"post",
...
function showdata(refer_id){
    ...
    $.ajax({
      url:"allfunction.php?call=project_personal_chat",
      method:"post",
      data:{refer_id:refer_id},
      success:function(data){
        console.log(data);
