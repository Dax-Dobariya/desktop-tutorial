                            ...
                            <form class="form-horizontal" method="POST" id="form" autocomplete="off">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6 col-sm-6">
                                            <label for="yera">Select year*</label>
                                            <select name="years" class="form-control" id="year" required>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6 col-sm-6">
                                            ...
                                            <input type="text" class="form-control input-sm" Placeholder="Enter  Enrollement no"name="erno" id="erno" required>
...
<?php
  ...
  if(isset($_POST['submit'])){ 
     ...
     $er_no=trim($_POST['erno']);
     $email_id=trim($_POST['emailid']);
     $phone=trim($_POST['contactno']);
     $password=trim($_POST['password']);
    
    $insertquery="insert into Registration(`firstname`, `lastname`, `course`, `occupation`, `year`, `gender`, `er_no`, `email_id`,`contactno`,`password`) values('$fname','$lname','$course','Student','$year','$gender','$er_no','$email_id','$phone','$password')";
